...
#SBATCH --job-name="mpi20"
#SBATCH --mail-user=cllbra005@myuct.ac.za
...
do
    ...
    do
        eval "mpirun ./bin/serialFilter data/small10 out $filterSize >> time/serialSmall$filterSize"
        eval "mpirun ./bin/serialFilter data/medium30 out $filterSize >> time/serialMedium$filterSize"
        #eval "mpirun ./bin/serialFilter data/large50 out $filterSize >> time/serialLarge$filterSize"
        eval "mpirun ./bin/serialFilter data/smallsize out $filterSize >> time/serialSmallsize$filterSize"
        #eval "mpirun ./bin/serialFilter data/largesize out $filterSize >> time/serialLargesize$filterSize"
