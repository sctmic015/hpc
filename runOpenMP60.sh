...
#SBATCH --nodes=1 --ntasks=60
#SBATCH --job-name="openMP 60 core"
...
#        eval "./bin/serialFilter data/large50 out $filterSize >> time/serialLarge$filterSize"
        eval "./bin/ompFilter data/small10 out $filterSize >> time/ompSmall60$filterSize"
        eval "./bin/ompFilter data/medium30 out $filterSize >> time/ompMedium60$filterSize"
        eval "./bin/ompFilter data/large50 out $filterSize >> time/ompLarge60$filterSize"
        eval "./bin/ompFilter data/smallsize out $filterSize >> time/ompSmallsize60$filterSize"
        eval "./bin/ompFilter data/largesize out $filterSize >> time/ompLargesize60$filterSize"
