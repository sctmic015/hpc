...
#SBATCH --job-name="openMP 40 core"
...
#        eval "./bin/serialFilter data/large50 out $filterSize >> time/serialLarge$filterSize"
        eval "./bin/ompFilter data/small10 out $filterSize >> time/ompSmall40$filterSize"
        eval "./bin/ompFilter data/medium30 out $filterSize >> time/ompMedium40$filterSize"
        eval "./bin/ompFilter data/large50 out $filterSize >> time/ompLarge40$filterSize"
        eval "./bin/ompFilter data/smallsize out $filterSize >> time/ompSmallsize40$filterSize"
        eval "./bin/ompFilter data/largesize out $filterSize >> time/ompLargesize40$filterSize"
